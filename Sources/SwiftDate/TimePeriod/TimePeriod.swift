...
///
/// Required variables and method implementations are bound below.
///
...
open class TimePeriod: TimePeriodProtocol {
    ...
    ///
	/// For example, to shift the given period by 3 days you might do this:
    ///
    /// ```swift
    /// let shifted = period.shifted(by: 3.days)
    /// ```
	///
